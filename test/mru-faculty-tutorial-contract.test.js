...
describe('MRUFacultyTutorialContract', function() {
    ...
    describe('getEarningsSchedules', function() {
        ...
        it('returns a schedule with vacation pay too - fall', function() {
            ...
            var contract = contractFactory.createMRUFacultyTutorialContract(contractDetails);

            var expectedLectureSchedule = new Schedule("mru tutorial pay");
